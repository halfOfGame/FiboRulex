...
-- 增加策略Code
ALTER TABLE `t_monitor_strategy`
    ADD COLUMN `strategy_version_code` varchar(200) NULL COMMENT '策略版本code' AFTER `create_time`;
...
-- ----------------------------
-- Table structure for schedule_job   定时任务配置
-- ----------------------------
